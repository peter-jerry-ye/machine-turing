...
public class Fenetre extends JFrame {
	...
	private String[] columnTitle = {"Etat present", "Symbole lu"
			, "Nouvel etat", "Symbol ecrit", "Action"};
	...
	/**
	 * Le class pour avancer Turing_Machine et update le JTextField
	 */
	...
	/**
	 * Le class qui change le table en creation de nouvelle machine
	 */
	...
	/**
	 * Le class qui change le machine
	 */
