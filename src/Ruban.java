...
/**
 * La class qui represent un ruban
 *
 * @author VANNIER Corentin
 */
public class Ruban {
	...
	/**
	 * Le string qui separe des symboles dans l'entree et sortie
	 */
	 ...
	 *
	 * @param texte			 Texte contenant les informations sur le ruban
